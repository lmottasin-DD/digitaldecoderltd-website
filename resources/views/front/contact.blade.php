    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <form action="{{route('clientInfo.store')}}" method="post" role="form" class="php-email-form">
              @csrf
              <div class="row">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="client_subject" id="client_subject" placeholder="Subject" required>
              </div>
              <div class="form-group mt-3">
                <textarea class="form-control" name="client_message" rows="5" placeholder="Message" required></textarea>
              </div>
              <div class="my-3">
