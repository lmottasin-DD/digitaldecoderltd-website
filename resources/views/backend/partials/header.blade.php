...
<head>
		...
		<meta charset="utf-8" />
		<title>Dashboard - Digital Decoder</title>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="{{asset('assets/backend')}}/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="{{asset('assets/backend')}}/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
		<link rel="stylesheet" href="{{asset('assets/backend')}}/css/ace-skins.min.css" />
		...
		<script src="{{asset('assets/backend')}}/js/ace-extra.min.js"></script>
