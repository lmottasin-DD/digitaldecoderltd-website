                                                ...
                                                <div class="card-body"><h5 class="card-title">Slider Information:</h5>
                                                    ...
                                                    <form  >
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input  type="text" class="form-control" value="{{ $single_data->name }}" disabled>
                                                        </div>

                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Email</label>
                                                            <input  type="text" class="form-control" value="{{ $single_data->email }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Subject</label>
                                                            <input   type="text" class="form-control" value="{{ $single_data->subject }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Sent At</label>
                                                            <input   type="text" class="form-control" value="{{ $single_data->created_at->format('Y-m-d') }}" disabled>
                                                        </div>
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <textarea class="form-control" name="title_description" disabled>{{  $single_data ->message}} </textarea>
