                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Edit Service Data</h5>
                                                    @if($errors->any())
                                                    ...
                                                    <form method="POST" action="{{ route('testimonial.update',$single_data ->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Name</label>
                                                            <input name="name"   type="text" class="form-control" value="{{ $single_data ->name  }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Quote</label>
                                                            <input name="quote"  type="text" class="form-control" value="{{ $single_data ->quote  }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Designation</label>
                                                            <input name="designation"  type="text" class="form-control" value="{{ $single_data ->designation  }}">
                                                        </div>
