                                        ...
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('footer.update',$all_data -> id ) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Address</label>
                                                            <input name="address"   type="text" class="form-control" value="{{ $all_data ->address }}"  >
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Phone</label>
                                                            <input name="phone"   type="text" class="form-control" value="{{ $all_data ->phone  }}"  >
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Email</label>
                                                            <input name="email"   type="text" class="form-control" value="{{ $all_data ->email  }}"  >
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Facebook Link</label>
                                                            <input name="facebook_link"   type="text" class="form-control" value="{{ $all_data ->facebook_link  }}"  >
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Linkedin Link</label>
                                                            <input name="linkedin_link"   type="text" class="form-control" value="{{ $all_data ->linkedin_link  }}"  >
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Youtube Link</label>
                                                            <input name="youtube_link"   type="text" class="form-control" value="{{ $all_data ->youtube_link }}"  >
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Twitter Link</label>
                                                            <input name="twitter_link"   type="text" class="form-control" value="{{ $all_data -> twitter_link }}"  >
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Instagram Link</label>
                                                            <input name="instagram_link"   type="text" class="form-control" value="{{ $all_data ->instagram_link  }}"  >
                                                        </div>
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <img style="width: 50%; height: 50%;" src="{{ url('media/footer_image/'.$all_data->logo) }}" alt="">
                                                            <br>
                                                            <br>
                                                            <input name="old_photo"  type="text" class="form-control-file" value="{{ $all_data ->logo }}" hidden>
