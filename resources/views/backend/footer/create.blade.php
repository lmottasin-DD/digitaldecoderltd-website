                                                ...
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('footer.store') }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="facebook_link"   type="text" class="form-control" value="{{ old('facebook_link') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Linkedin Link</label>
                                                            <input name="linkedin_link"   type="text" class="form-control" value="{{old('linkedin_link') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Youtube Link</label>
                                                            <input name="youtube_link"   type="text" class="form-control" value="{{old('youtube_link') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Twitter Link</label>
                                                            <input name="twitter_link"   type="text" class="form-control" value="{{old('twitter_link') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Instagram Link</label>
                                                            <input name="instagram_link"   type="text" class="form-control" value="{{old('instagram_link') }}">
                                                        </div>
