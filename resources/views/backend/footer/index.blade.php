                                                ...
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form  >
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="address"   type="text" class="form-control" value="{{ $all_data ->address }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Phone</label>
                                                            <input name="phone"   type="text" class="form-control" value="{{ $all_data ->phone  }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Email</label>
                                                            <input name="email"   type="text" class="form-control" value="{{ $all_data ->email  }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Facebook Link</label>
                                                            <input name="facebook_link"   type="text" class="form-control" value="{{ $all_data ->facebook_link  }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Linkedin Link</label>
                                                            <input name="linkedin_link"   type="text" class="form-control" value="{{ $all_data ->linkedin_link  }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Youtube Link</label>
                                                            <input name="youtube_link"   type="text" class="form-control" value="{{ $all_data ->youtube_link }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Twitter Link</label>
                                                            <input name="twitter_link"   type="text" class="form-control" value="{{ $all_data -> twitter_link }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Instagram Link</label>
                                                            <input name="instagram_link"   type="text" class="form-control" value="{{ $all_data ->instagram_link  }}" disabled>
                                                        </div>
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <br>
                                                            <img style="width: 30%;height: 30%;" src="{{ asset('media/footer_image/'.$all_data->logo) }}" alt="">
