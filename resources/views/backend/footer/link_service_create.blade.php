                                        ...
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('footer.useful.service.add') }}" >
                                                        @csrf
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Useful Link Title</label>
                                                            <input name="useful_link_title"   type="text" class="form-control" value="{{old('useful_link_title') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Useful Link weblink</label>
                                                            <input name="useful_link_weblink"   type="text" class="form-control" value="{{old('useful_link_weblink') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Our Service  Title</label>
                                                            <input name="our_service_title"   type="text" class="form-control" value="{{old('our_service_title') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Our service weblink</label>
                                                            <input name="our_service_weblink"   type="text" class="form-control" value="{{old('our_service_weblink') }}">
                                                        </div>
