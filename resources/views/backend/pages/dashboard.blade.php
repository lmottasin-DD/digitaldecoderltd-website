                                                ...
                                                <div class="itemdiv memberdiv">
                                                    <div class="user">
                                                        <img alt="Bob Doe's avatar"
                                                            src="{{ asset('assets/backend') }}/images/avatars/user.jpg" />
                                                    </div>
                                                ...
                                                <div class="itemdiv memberdiv">
                                                    <div class="user">
                                                        <img alt="Joe Doe's avatar"
                                                            src="{{ asset('assets/backend') }}/images/avatars/avatar2.png" />
                                                    </div>
                                                ...
                                                <div class="itemdiv memberdiv">
                                                    <div class="user">
                                                        <img alt="Jim Doe's avatar"
                                                            src="{{ asset('assets/backend') }}/images/avatars/avatar.png" />
                                                    </div>
                                                ...
                                                <div class="itemdiv memberdiv">
                                                    <div class="user">
                                                        <img alt="Alex Doe's avatar"
                                                            src="{{ asset('assets/backend') }}/images/avatars/avatar5.png" />
                                                    </div>
                                                ...
                                                <div class="itemdiv memberdiv">
                                                    <div class="user">
                                                        <img alt="Susan's avatar"
                                                            src="{{ asset('assets/backend') }}/images/avatars/avatar3.png" />
                                                    </div>
                                                ...
                                                <div class="itemdiv memberdiv">
                                                    <div class="user">
                                                        <img alt="Phil Doe's avatar"
                                                            src="{{ asset('assets/backend') }}/images/avatars/avatar4.png" />
                                                    </div>
                                                ...
                                                <div class="itemdiv memberdiv">
                                                    <div class="user">
                                                        <img alt="Alexa Doe's avatar"
                                                            src="{{ asset('assets/backend') }}/images/avatars/avatar1.png" />
                                                    </div>
                                        ...
                                        <div class="itemdiv dialogdiv">
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="text">Lorem ipsum dolor sit amet, consectetur
                                                    adipiscing elit. Quisque commodo massa sed ipsum porttitor facilisis.
                                                </div>
