                    ...
                    <div class="col-md-12">
                        <div class="">
                            <div class="widget-header">
                                <h4 class="widget-title col-md-11">Edit CompanyInfo </h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('companyInfo.update',$Info_edit->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_location" class="form-control"
                                                value="{{ $Info_edit->company_location }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="status"
                                                {{ $Info_edit->status == '1' ? 'checked' : '' }}> 0=Deactive,1=Active
                                            @error('status')
                                                <span class="text-danger">
                                                    {{ $message }}
                                                </span>
