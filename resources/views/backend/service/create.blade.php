                                                ...
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('service.store') }}" >
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="icon"  placeholder="Enter icon name here." type="text" class="form-control" value="{{old('icon') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Title</label>
                                                            <input name="title"  placeholder="Enter title  here." type="text" class="form-control" value="{{old('title') }}">
                                                        </div>

                                                        <div class="position-relative form-group">
                                                            <label for="exampleText" class="">Description</label>
                                                            <textarea placeholder="Enter description here."class="form-control" name="description">{{ old('description') }}</textarea>
