                                        ...
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Edit Service Data</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('service.update',$single_data ->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="icon"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data ->icon  }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Icon Show</label>
                                                            <p><i class="{{ $single_data -> icon }}"></i></p>
                                                        </div>
