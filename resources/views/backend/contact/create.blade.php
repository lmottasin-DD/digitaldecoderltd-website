                                                ...
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('contact.store') }}" >
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="location"  placeholder="Enter location here." type="text" class="form-control" value="{{old('icon') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Email</label>
                                                            <input name="email"  placeholder="Enter email  here." type="text" class="form-control" value="{{old('title') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Call</label>
                                                            <input name="call"  placeholder="Enter call details  here." type="text" class="form-control" value="{{old('title') }}">
                                                        </div>
