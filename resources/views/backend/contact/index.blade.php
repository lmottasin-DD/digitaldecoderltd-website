                                                ...
                                                <table class="mb-0 table">
                                                    ...
                                                    @foreach( $all_data as $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if( $data->status == 0)
                                                                    <a href="{{ route('contact.status.change',$data->id) }}" class="badge badge-danger">unpublished</a>
                                                                @else
                                                                    <a href="{{ route('contact.status.change',$data->id) }}" class="badge badge-success">published</a>
                                                                @endif
                                                            </td>
                                                            <td>


                                                                <a class="btn btn-sm btn-info" href="{{ route('contact.edit',$data->id) }}"><i class="fas fa-edit "></i></a>

                                                                <form style="display: inline" action="{{ route('contact.destroy',$data->id) }}" method="POST" >
                                                                    @csrf
                                                                    @method('DELETE')
