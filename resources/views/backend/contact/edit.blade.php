                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Edit Contact Data</h5>
                                                    @if($errors->any())
                                                    ...
                                                    <form method="POST" action="{{ route('contact.update',$single_data ->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Location</label>
                                                            <input name="location"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data ->location  }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Email</label>
                                                            <input name="email"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data ->email  }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Call</label>
                                                            <input name="call"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data ->call  }}">
                                                        </div>
