                                        ...
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('portfolio.update',$single_data ->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Link</label>
                                                            <input name="link"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data ->link  }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Type</label>
                                                            <input name="type"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data ->type  }}">
                                                        </div>


                                                        <div class="position-relative form-group">
                                                            <label for="exampleFile" class="">Previously Added Photo</label>
                                                            <img style="width: 50%; height: 50%;" src="{{ url('media/portfolio_image/'.$single_data->photo) }}" alt="">
                                                            <br>
                                                            <br>
