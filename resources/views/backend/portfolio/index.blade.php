                                                ...
                                                <table class="mb-0 table">
                                                    ...
                                                    @foreach( $all_data as $data)
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->title }}</td>
                                                            <td>
                                                                <img style="width: 30px;height: 30px;" src="{{ url('media/portfolio_image/'.$data->photo) }}" alt="">
                                                            </td>
                                                            <td>{{ $data->type }}</td>
                                                            <td>{{ $data->link }}</td>
                                                            ...
                                                            <td>
                                                                @if( $data->status == 0)
                                                                    <a href="{{ route('portfolio.status.change',$data->id) }}" class="badge badge-danger">unpublished</a>
                                                                @else
                                                                    <a href="{{ route('portfolio.status.change',$data->id) }}" class="badge badge-success">published</a>
                                                                @endif
                                                            </td>
                                                            <td>

                                                                <a href="{{ route('portfolio.show',$data->id) }}" class="btn btn-sm btn-dark"><i class="fas fa-eye"></i></a>
                                                                <a class="btn btn-sm btn-info" href="{{ route('portfolio.edit',$data->id) }}"><i class="fas fa-edit "></i></a>

                                                                <form style="display: inline" action="{{ route('portfolio.destroy',$data->id) }}" method="POST" >
                                                                    @csrf
                                                                    @method('DELETE')
