                                                ...
                                                <div class="card-body"><h5 class="card-title">Slider Information:</h5>
                                                    ...
                                                    <form  >
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="title"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data->type }}" disabled>
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Link</label>
                                                            <input name="title"  placeholder="Enter your title here." type="text" class="form-control" value="{{ $single_data->link }}" disabled>
                                                        </div>
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <img style="width: 30%; height: 30%;" src="{{ url('media/portfolio_image/'.$single_data->photo) }}" alt="">
