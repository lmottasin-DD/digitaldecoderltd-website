                                                ...
                                                <table class="mb-0 table">
                                                    ...
                                                    @foreach( $all_data as $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if( $data->status == 0)
                                                                    <a href="{{ route('cta.status.change',$data->id) }}" class="badge badge-danger">unpublished</a>
                                                                @else
                                                                    <a href="{{ route('cta.status.change',$data->id) }}" class="badge badge-success">published</a>
                                                                @endif
                                                            </td>
                                                            <td>

                                                                <a href="{{ route('cta.show',$data->id) }}" class="btn btn-sm btn-dark"><i class="fas fa-eye"></i></a>
                                                                <a class="btn btn-sm btn-info" href="{{ route('cta.edit',$data->id) }}"><i class="fas fa-edit "></i></a>

                                                                <form style="display: inline" action="{{ route('cta.delete',$data->id) }}" method="POST" >
                                                                    @csrf
                                                                    @method('DELETE')
