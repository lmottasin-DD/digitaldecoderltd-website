                                        ...
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">About Page</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('sub-about.store') }}"  >
                                                        @csrf
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Heading</label>
                                                            <input name="sub_heading"   type="text" class="form-control" value="{{old('sub_heading') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Description</label>
                                                            <input name="sub_description"   type="text" class="form-control" value="{{old('sub_description') }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Icon</label>
