                                        ...
                                        <div class="col-md-12">
                                            <div class="main-card mb-3 card">
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('sub-about.update',$single_data ->id) }}" >
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Heading</label>
                                                            <input name="sub_heading"   type="text" class="form-control" value="{{ $single_data ->sub_heading  }}">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail" class="">Icon Name</label>
                                                            <input name="icon"   type="text" class="form-control" value="{{ $single_data ->icon  }}">
                                                        </div>


                                                        <div class="position-relative form-group">
                                                            <label for="exampleText" class="">Description</label>
                                                            <textarea placeholder="Enter description"class="form-control" name="sub_description">{{ $single_data->sub_description }}</textarea>
