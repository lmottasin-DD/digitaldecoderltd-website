                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">About Information</h5>
                                                ...
                                                <table class="mb-0 table">
                                                    ...
                                                    @foreach( $all_data as $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img style="width: 30px;height: 30px;" src="{{ url('media/about_image/'.$data->photo) }}" alt="">
                                                            </td>

                                                            <td>
                                                                @if( $data->status == 0)
                                                                    <a href="{{ route('about.status.change',$data->id) }}" class="badge badge-danger">unpublished</a>
                                                                @else
                                                                    <a href="{{ route('about.status.change',$data->id) }}" class="badge badge-success">published</a>
                                                                @endif
                                                            </td>
                                                            <td>

                                                                <a href="{{ route('about.show',$data->id) }}" class="btn btn-sm btn-dark"><i class="fas fa-eye"></i></a>
                                                                <a class="btn btn-sm btn-info" href="{{ route('about.edit',$data->id) }}"><i class="fas fa-edit "></i></a>

                                                                <form style="display: inline" action="{{ route('about.destroy',$data->id) }}" method="POST" >
                                                                    @csrf
                                                                    @method('DELETE')
