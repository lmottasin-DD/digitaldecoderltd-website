                                                ...
                                                <div class="card-body"><h5 class="card-title">Controls Types</h5>
                                                    ...
                                                    <form method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="title" id="exampleEmail" placeholder="Enter your title here." type="text" class="form-control">
                                                        </div>
                                                        <div class="position-relative form-group">
                                                            <label for="exampleText" class="">Text Area</label>
                                                            <textarea placeholder="Enter description" name="title_description" id="exampleText" class="form-control"></textarea>
                                                        </div>
